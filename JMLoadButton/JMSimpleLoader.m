...
- (NSArray<NSNumber*>*)create_Fast_First_Cirlce_StrokeEnd_Values {
    ...
    NSArray<NSNumber*>* firstCirlce_StrokeEnd_Values = @[@(firstCirlce_Stage0_StrokeEnd),@(firstCirlce_Stage1_StrokeEnd),@(firstCirlce_Stage2_StrokeEnd),@(firstCirlce_Stage3_StrokeEnd),@(firstCirlce_Stage4_StrokeEnd)];
...
- (NSArray<NSNumber*>*)create_Fast_First_Cirlce_StrokeStart_Values {
    ...
    NSArray<NSNumber*>* firstCirlce_StrokeStart_Values = @[@(firstCirlce_Stage0_StrokeStart),@(firstCirlce_Stage1_StrokeStart),@(firstCirlce_Stage2_StrokeStart),@(firstCirlce_Stage3_StrokeStart),@(firstCirlce_Stage4_StrokeStart)];
...
- (NSArray<NSNumber*>*)create_Slow_First_Cirlce_StrokeEnd_Values {
    ...
    NSArray<NSNumber*>* firstCirlce_StrokeEnd_Values = @[@(firstCirlce_Stage0_StrokeEnd),@(firstCirlce_Stage1_StrokeEnd),@(firstCirlce_Stage2_StrokeEnd),@(firstCirlce_Stage3_StrokeEnd),@(firstCirlce_Stage4_StrokeEnd),@(firstCirlce_Stage5_StrokeEnd)];
    return firstCirlce_StrokeEnd_Values;
}
...
- (NSArray<NSNumber*>*)create_Slow_First_Cirlce_StrokeStart_Values {
    ...
    NSArray<NSNumber*>* firstCirlce_StrokeStart_Values = @[@(firstCirlce_Stage0_StrokeStart),@(firstCirlce_Stage1_StrokeStart),@(firstCirlce_Stage2_StrokeStart),@(firstCirlce_Stage3_StrokeStart),@(firstCirlce_Stage4_StrokeStart),@(firstCirlce_Stage5_StrokeStart)];
    return firstCirlce_StrokeStart_Values;
}
...
- (NSArray<NSNumber*>*)create_Fast_Second_Cirlce_StrokeEnd_Values {
    ...
    NSArray<NSNumber*>* secondCirlce_StrokeEnd_Values = @[@(secondCirlce_Stage0_StrokeEnd),@(secondCirlce_Stage1_StrokeEnd),@(secondCirlce_Stage2_StrokeEnd),@(secondCirlce_Stage3_StrokeEnd),@(secondCirlce_Stage4_StrokeEnd)];
...
- (NSArray<NSNumber*>*)create_Fast_Second_Cirlce_StrokeStart_Values {
    ...
    NSArray<NSNumber*> *secondCirlce_StrokeStart_Values = @[@(secondCirlce_Stage0_StrokeStart),@(secondCirlce_Stage1_StrokeStart),@(secondCirlce_Stage2_StrokeStart),@(secondCirlce_Stage3_StrokeStart),@(secondCirlce_Stage4_StrokeStart)];
...
- (NSArray<NSNumber*>*)create_Slow_Second_Cirlce_StrokeEnd_Values {
    ...
    NSArray<NSNumber*>* secondCirlce_StrokeEnd_Values = @[@(secondCirlce_Stage0_StrokeEnd),@(secondCirlce_Stage1_StrokeEnd),@(secondCirlce_Stage2_StrokeEnd),@(secondCirlce_Stage3_StrokeEnd),@(secondCirlce_Stage4_StrokeEnd),@(secondCirlce_Stage5_StrokeEnd)];
    return secondCirlce_StrokeEnd_Values;
}
...
- (NSArray<NSNumber*>*)create_Slow_Second_Cirlce_StrokeStart_Values {
    ...
    NSArray<NSNumber*> *secondCirlce_StrokeStart_Values = @[@(secondCirlce_Stage0_StrokeStart),@(secondCirlce_Stage1_StrokeStart),@(secondCirlce_Stage2_StrokeStart),@(secondCirlce_Stage3_StrokeStart),@(secondCirlce_Stage4_StrokeStart),@(secondCirlce_Stage5_StrokeStart)];
    return secondCirlce_StrokeStart_Values;
}
...
- (NSArray<NSNumber*>*)create_Third_Cirlce_StrokeEnd_Values {
    ...
    NSArray<NSNumber*>* thirdCirlce_StrokeEnd_Values = @[@(thirdCirlce_Stage0_StrokeEnd),@(thirdCirlce_Stage1_StrokeEnd),@(thirdCirlce_Stage2_StrokeEnd),@(thirdCirlce_Stage3_StrokeEnd),@(thirdCirlce_Stage4_StrokeEnd),@(thirdCirlce_Stage5_StrokeEnd)];
...
- (NSArray<NSNumber*>*)create_Third_Cirlce_StrokeStart_Values {
    ...
    NSArray<NSNumber*>* thirdCirlce_StrokeEnd_Values = @[@(thirdCirlce_Stage0_StrokeStart),@(thirdCirlce_Stage1_StrokeStart),@(thirdCirlce_Stage2_StrokeStart),@(thirdCirlce_Stage3_StrokeStart),@(thirdCirlce_Stage4_StrokeStart),@(thirdCirlce_Stage5_StrokeStart)];
    return thirdCirlce_StrokeEnd_Values;
}
